const actual_weights_daily_applicable_dates = (user_id, time_zone, start_date, end_date) => {
  ...
  const user_id_applicable_dates = require("./actual_weights_user_id_applicable_dates")(user_id);
  return `
    (
      select 
        uid_ad.user_id,
