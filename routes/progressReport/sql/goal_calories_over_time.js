const goal_calories_over_time = (user_id, time_zone, start_date, end_date) => {
  ...
  const daily_applicable_dates = require("./goal_calories_daily_applicable_dates")(
    user_id,
    time_zone,
    start_date,
    end_date
...
module.exports = goal_calories_over_time;
