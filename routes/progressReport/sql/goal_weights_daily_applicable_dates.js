const goal_weights_daily_applicable_dates = (user_id, time_zone, goal_start_date, goal_end_date) => {
  ...
  const goal_weights_user_id_applicable_dates = require("./goal_weights_user_id_applicable_dates")(user_id);
  return `
    (
      select 
        a.user_id,
      ...
      inner join ${goal_weights_user_id_applicable_dates} -- as a
      on 
