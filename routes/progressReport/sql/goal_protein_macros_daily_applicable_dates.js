const goal_protein_macros_daily_applicable_dates = (
  user_id,
  time_zone,
  start_date,
  end_date
  ...
  const user_id_applicable_dates = require("./goal_protein_ratio_user_id_applicable_dates")(
    user_id
  );
  return `
    (
...
module.exports = goal_protein_macros_daily_applicable_dates;
