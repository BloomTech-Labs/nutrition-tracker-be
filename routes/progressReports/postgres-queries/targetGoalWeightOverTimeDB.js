...
const targetGoalWeightOverTimeDB = async (user_id, time_zone, start_date, end_date) => {
  ...
  const queryString = require("./sql/target_goal_weights_over_time")(user_id, time_zone, start_date, end_date);
  // console.log(queryString);
  return await pgPromiseDb.any(queryString);
};

module.exports = targetGoalWeightOverTimeDB;
