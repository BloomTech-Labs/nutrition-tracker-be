const goal_fat_macros_daily_applicable_dates = (
  user_id,
  time_zone,
  start_date,
  end_date
  ...
  const user_id_applicable_dates = require("./goal_fat_ratio_user_id_applicable_dates")(
    user_id
  );
  return `
    (
...
module.exports = goal_fat_macros_daily_applicable_dates;
